 ...
 * JEG 04-16-04 
 *
 * Added ATmega8515 to struct device device_list[].
 * Alexey Pavluchenko, 16.Nov.2005
 *
 * Added ATtiny25, ATtiny45 and ATtiny85 to struct device device_list[].  
 * Added "DF_NO_JMP|" to ATmega8 struct device device_list[].  
 * JEG 11-27-06 
 */
